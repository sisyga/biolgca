...
Cells either migrate (in velocity channels) or rest and divide (in rest
channels), and switch between the two depending on how crowded their node is:
a moving cell starts resting with probability
...
def build_initial_nodes() -> np.ndarray:
    """Seed one fully occupied node in the centre: 6 moving and 6 resting cells."""
