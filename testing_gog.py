...
# lgca = get_lgca(ib=True, bc='reflect', interaction='go_or_grow_kappa', dims=l, nodes=d['nodes_t'], ve=False, geometry='lin',
#                 r_b=r_b, capacity=capacity, r_d=r_d, kappa=d['kappa'], theta=.3, kappa_std=.2)
